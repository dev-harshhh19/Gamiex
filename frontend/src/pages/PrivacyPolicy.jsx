    ...
    <div className="container mx-auto p-4">
      ...
      <div className="bg-card p-6 rounded-lg shadow-md">
        ...
        <ul className="list-disc list-inside mt-2">
          ...
          <li>
            <p><strong>Website</strong> refers to Gamiex, accessible from http://localhost:3000 (or your deployed domain).</p>
          </li>
          <li>
            <p><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</p>
          </li>
        </ul>
        <h2 className="text-2xl font-semibold text-foreground mt-6">Collecting and Using Your Personal Data</h2>
        <h3 className="text-xl font-semibold text-foreground mt-4">Types of Data Collected</h3>
        <h4 className="text-lg font-semibold text-foreground mt-2">Personal Data</h4>
        ...
        <h4 className="text-lg font-semibold text-foreground mt-2">Usage Data</h4>
        ...
        <h4 className="text-lg font-semibold text-foreground mt-2">Payments</h4>
        <p className="mt-2">We use third-party payment processors (e.g., PayPal) to process payments securely. We do not store full payment card numbers on our servers. Payment information is handled by the processor in accordance with their privacy policy.</p>
        <h4 className="text-lg font-semibold text-foreground mt-2">Tracking Technologies and Cookies</h4>
        ...
        <p className="mt-2">Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. You can learn more about cookies here: <a href="https://www.termsfeed.com/blog/cookies/" target="_blank" rel="noreferrer noopener" className="text-primary hover:underline">All About Cookies by TermsFeed</a>.</p>
        ...
        <h3 className="text-xl font-semibold text-foreground mt-4">Use of Your Personal Data</h3>
        ...
        <h3 className="text-xl font-semibold text-foreground mt-4">Retention of Your Personal Data</h3>
        ...
        <h3 className="text-xl font-semibold text-foreground mt-4">Transfer of Your Personal Data</h3>
        ...
        <h3 className="text-xl font-semibold text-foreground mt-4">Disclosure of Your Personal Data</h3>
        <h4 className="text-lg font-semibold text-foreground mt-2">Business Transactions</h4>
        ...
        <h4 className="text-lg font-semibold text-foreground mt-2">Law enforcement</h4>
        ...
        <h4 className="text-lg font-semibold text-foreground mt-2">Other legal requirements</h4>
        ...
        <h3 className="text-xl font-semibold text-foreground mt-4">Security of Your Personal Data</h3>
        <p className="mt-2">The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>
        <h2 className="text-2xl font-semibold text-foreground mt-6">Children's Privacy</h2>
        ...
        <h2 className="text-2xl font-semibold text-foreground mt-6">Links to Other Websites</h2>
        ...
        <h2 className="text-2xl font-semibold text-foreground mt-6">Changes to this Privacy Policy</h2>
